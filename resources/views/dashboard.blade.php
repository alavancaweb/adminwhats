...
<div id="app">
        <div class="form-group mb-2">
            ...
            <label for="client-idd">Usuário</label><br>
            <input type="text" id="client-id" placeholder="Usuário">
        </div>
        <div class="form-group mb-2">
            <label for="client-token">Departamento</label><br>
            <input rows="3" id="client-token" placeholder="Departamento">
            <br><br>
            <button class="add-client-btn btn-primary">Criar Usuário</button>
        </div>
        <hr>
        <div class="form-group mb-2">
            <h3>Deletar Usuário</h3>
            <label for="client-id">Usuário</label><br>
            <input type="text" id="client-idd" placeholder="Usuário">
        </div>
        <div class="form-group mb-2">
            <label for="client-tokenn">Departamento</label><br>
            <input rows="3" id="client-tokenn" placeholder="Departamento">
            <br><br>
            <button class="destroy-client-btn btn-danger">Deletar Usuários</button>
        </div>
    <hr>
